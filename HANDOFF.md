...
- `faq/40-ecosystem/what-is-eb-labs.md` — describes EB Labs publicly **while its positioning is still being defined in eb-labs-web**; these two must stay consistent, and Exec approval of the EB Labs positioning should come first
