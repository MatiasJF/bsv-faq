---
id: what-bsva-does-not-do
question: "What does the BSV Association NOT do?"
category: 40-ecosystem
tags: [ecosystem, bsva, misconceptions]
level: beginner
updated: 2026-07-03
sources:
...
**Short answer.** The Association does not run exchanges or decide their listings, does not hold or recover anyone's coins, does not control the network or reverse transactions, does not set fees or prices, and does not license companies (regulators do that). Most ecosystem frustrations land on the Association's doorstep anyway — this page exists to say, factually, which doors it actually has keys to.
...
- **Licensing**: it is not a regulator; it neither grants nor withholds any company's authorization ([[who-regulates-crypto]]).

What remains is its actual job — protocol stewardship, software, standards, education, promotion ([[what-is-the-bsv-association]]) — which is substantial, but categorically different from the powers often attributed to it.
